        ...
        <div align="left">
          ...
          <td> 
            <select name="size" id="lang-select">
              <option value="XS" id = "1"checked = "checked">man hinh</option>
              <option value="S" id ="2">chuot</option>
              <option value="M" id="3">ban phim</option>
              <option value="L" id ="4">ram</option>
              <option value="1XL"id = "5">o cung</option>
              <option value="2XL" id = "6">tai nghe</option>
              <option value="3XL" id = "7">loa</option>
            </select> 
            <div class="has-erros">
